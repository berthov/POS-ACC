...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2018 at 07:54 AM
...
INSERT INTO `po_header_all` (`po_header_id`, `po_date`, `supplier`, `ship_to`, `outlets`, `created_date`, `created_by`, `last_update_by`, `last_update_date`) VALUES
('2147483647', '0000-00-00', 'cc', 'dd', 'aa', '2018-03-09', NULL, NULL, NULL);
...
INSERT INTO `po_line_all` (`po_line_id`, `po_header_id`, `item_code`, `uom`, `qty`, `price`, `created_date`, `created_by`, `last_update_date`, `last_update_by`) VALUES
...
--
ALTER TABLE `po_line_all`
  MODIFY `po_line_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
