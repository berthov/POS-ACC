            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left input_mask " action="controller/doaddnewoutlet.php" method="POST">

                      <div class="col-md-5 col-sm-5 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="outlet_name" name="outlet_name" placeholder="Outlet Name" required="required">
                      ...
                      <div class="col-md-5 col-sm-5 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control" id="phone" placeholder="Phone" required ="required" name="phone">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input type="text" class="form-control" placeholder="Default Input" required ="required" name="city">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Province</label>
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input type="text" class="form-control" placeholder="Default Input" required ="required" name="province">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Postal Code</label>
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input type="text" class="form-control" placeholder="Default Input" required ="required" name="postal_code">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Date Of Founded 
                        </label>
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <fieldset>
                            <div class="control-group">
                              <div class="controls">
                                  <input type="text" class="form-control has-feedback-left" id="single_cal2" placeholder="First Name" aria-describedby="inputSuccess2Status2" name="date_founded" >
